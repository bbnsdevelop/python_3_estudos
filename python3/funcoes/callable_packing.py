...
if __name__ == '__main__':
    preco_bruto = 134.98
    preco_final = calc_preco_final(preco_bruto, calc_imposto_importado, True)
    preco_final = calc_preco_final(preco_final, cal_imposto_explosivo, True, 1.5)
    print(f'Preço final do produto calculado os impostos é {preco_final}')
